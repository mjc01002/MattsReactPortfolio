...
return (
    <section className="container">
        ...
        <form class="justify-content-center" id="contact-form">
            ...
            <div class="mt-5 mb-5 formText" >
            <button data-testid='button' class="btn-outline-dark formText" type="submit" onSubmit={handleSubmit}>Submit</button>
            </div>
        </form>
    </section>
    );
